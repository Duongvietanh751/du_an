 ...
 <div class="section footer-section">
                        ...
                        <div class="footer-contact-payment">
                            <div class="footer-contact">
                                <div class="contact-icon">
                                    <img src="view/assets/images/icon/icon-4.png" width="39" height="46" alt="Icon" />
                                </div>
                            ...
                            <div class="footer-payment">
                                <img src="view/assets/images/payment.png" width="192" height="21" alt="Payment" />
                            </div>
                        </div>
                        <!-- Footer Contact & Payment End -->
                    </div>
                            ...
                            <div class="quick-view-images">
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="single-img">
                                                    <img src="view/assets/images/product-details/product-details-1.jpg" alt="Product Image" />
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="single-img">
                                                    <img src="view/assets/images/product-details/product-details-2.jpg" alt="Product Image" />
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="single-img">
                                                    <img src="view/assets/images/product-details/product-details-3.jpg" alt="Product Image" />
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="single-img">
                                                    <img src="view/assets/images/product-details/product-details-4.jpg" alt="Product Image" />
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="single-img">
                                                    <img src="view/assets/images/product-details/product-details-5.jpg" alt="Product Image" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="quick-gallery-thumbs">
                                    <div class="swiper-container">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <img src="view/assets/images/product-details/product-details-1.jpg" alt="Product Thumbnail" />
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="view/assets/images/product-details/product-details-2.jpg" alt="Product Thumbnail" />
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="view/assets/images/product-details/product-details-3.jpg" alt="Product Thumbnail" />
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="view/assets/images/product-details/product-details-4.jpg" alt="Product Thumbnail" />
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="view/assets/images/product-details/product-details-5.jpg" alt="Product Thumbnail" />
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Add Arrows -->
    ...
    <script src="view/assets/js/vendor/jquery-3.5.1.min.js"></script>

    <!-- Bootstrap JS -->
    <script src="view/assets/js/plugins/popper.min.js"></script>
    <script src="view/assets/js/plugins/bootstrap.min.js"></script>

    <!-- Plugins JS -->
    <script src="view/assets/js/plugins/swiper-bundle.min.js"></script>
    <script src="view/assets/js/plugins/ajax-contact.js"></script>
    <script src="view/assets/js/plugins/odometer.min.js"></script>
    <script src="view/assets/js/plugins/select2.min.js"></script>
    <script src="view/assets/js/plugins/ion.rangeSlider.min.js"></script>
...
<!-- Mirrored from htmldemo.net/furbar-1/furbar/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 Nov 2023 12:40:09 GMT -->
</html>